...
import poke.raftmgmt.HeartbeatData;
import poke.raftmgmt.HeartbeatManager;
import poke.raftmgmt.HeartbeatPusher;
import poke.raftmgmt.JobManager;
import poke.raftmgmt.NetworkManager;
...
//			logger.info(".....StartCommunication.run().....");
			try {
...
//			logger.info(".....StartManagement.run().....");
			EventLoopGroup bossGroup = new NioEventLoopGroup();
			EventLoopGroup workerGroup = new NioEventLoopGroup();
...
//		logger.info("Initializing server " + conf.getNodeId());
		...
		mthread.start();//networkmanager... calls processRequest() method internally

		StartCommunication comm = new StartCommunication(conf);
//		logger.info("Server " + conf.getNodeId() + " ready");

		Thread cthread = new Thread(comm);
		cthread.start();//electionmanager... calls processRequest() method internally
	}
	...
	public static void main(String[] args) {
		args=new String[1];
		args[0]="/home/sawla/workspace5/poke-netty/runtime/two/server1.conf";//done
